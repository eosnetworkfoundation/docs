...
![remix file explorer](./images/remix_file_explorer.png)
...
![remix new file](./images/remix_new_file.png)
...
![remix compile panel](./images/remix_compile_panel.png)
...
To connect the Remix IDE to the EOS EVM network you must first [connect your metamask wallet](../20_eos-evm-network/20_connect-metamask.md) to the EOS EVM network. You can connect to the EOS EVM main network or you can connect to any of the available EOS EVM test networks. For information about available EOS EVM networks please consult the [helpful links](../../65_helpful-links/index.md) section.
...
![remix deploy trx success](./images/remix_deploy_trx_success.png)
...
![remix deployed contracts panel](./images/remix_deployed_contracts_panel.png)
...
![remix deployed contracts panel 2](./images/remix_deployed_contracts_panel_2.png)
...
![remix log decoded input](./images/remix_log_decoded_input.png)
...
![remix onchain encoded data](./images/remix_onchain_encoded_data.png)

## Verify The Smart Contract

To verify the smart contract you need to identify four properties of the smart contract and then follow the steps outlined in the [how to verify a smart contract](./60_how-to-verify-a-smart-contract.md) document.
...
![remix compilation details](./images/remix_compilation_details.png)
...
With all the above information you can now follow the steps outline in the [how to verify a smart contract](./60_how-to-verify-a-smart-contract.md) document to get the job done.