...
| Hardware | Minimum | Recommended | Impacts                        |
| --- | --- | --- |--------------------------------|
| CPU | 4 cores | 8 cores | Txs per second                 |
| RAM | 16 GB | 32 GB | Compilation & processing speed |
| SSD | 100 GB | 1 TB | History storage                |
| Network | 100 Mbps | 1 Gbps | Network latency                |
...
| Binary                                     | Description                                     |
|--------------------------------------------|-------------------------------------------------|
| [leap](https://github.com/AntelopeIO/leap) | Main EOS blockchain node, CLI tool & CLI wallet |
| [cdt](https://github.com/AntelopeIO/cdt)   | EOS smart contract compiler                      |
| [EOS system contracts](https://github.com/eosnetworkfoundation/eos-system-contracts)                   | EOS system contracts, compiled by cdt |

### List of contracts needed

| Contract | Description |
| --- | --- |
| eosio.boot | Boot contract, used to initialize the blockchain |
| eosio.bios | BIOS contract, used to initialize the blockchain |

### Optional contracts
| Contract | Description |
| eosio.msig | Multisig contract, used to test multisig |
| eosio.token | Token contract, used to test token economy |
| eosio.system | System contract, used to test resources: RAM, NET, CPU |
...
You can find the proxy tool here: eos-evm/perfipherals/proxy
...
```shell
git clone https://github.com/eosnetworkfoundation/blockscout.git
cd blockscout
git checkout evm
cd docker
make
