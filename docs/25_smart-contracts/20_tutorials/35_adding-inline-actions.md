...
- [Inline Actions to External Contracts](./40_inline-action-to-external-contract.md): Learn how to construct actions and send those actions to an external contract.
