...
[[info | Built-in Types]]
| EOS implements a number of custom built-ins. Built-in types don't need to be described in an ABI file. If you would like to familiarize yourself with EOS built-ins, they are defined [here](https://github.com/eosnetworkfoundation/mandel/blob/main/libraries/chain/abi_serializer.cpp)
...
- [Data Persistence](./20_data-persistence.md): Learn how data persistence works on EOS by writing a simple smart contract that functions as an address book.
