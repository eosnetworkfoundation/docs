...
[[info | Note]]
| This section only applies to DPoS implementation of the Antelope consensus mechanism. If you choose not to use DPoS, System Resources are not required.
...
More details about RAM as a system resource can be found [here](https://developers.eos.io/manuals/eos-system-contracts/latest/key-concepts/ram).
...
More details about CPU as a system resource can be found [here](https://developers.eos.io/manuals/eos-system-contracts/latest/key-concepts/cpu).
...
More details about NET as a system resource can be found [here](https://developers.eos.io/manuals/eos-system-contracts/latest/key-concepts/net).
