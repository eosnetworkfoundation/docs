...
![](images/xact-sign.png "Transaction Signing")
<!--
```dot-svg
...
| Deferred transactions are deprecated as of Antelope 2.0. For more details on their behavior, refer to the [Deferred Transactions](https://docs.eosnetwork.com/manuals/cdt/v1.7/best-practices/deferred_transactions) section on the `cdt` documentation.
