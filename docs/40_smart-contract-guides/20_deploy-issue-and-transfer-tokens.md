...
Now check if `bob` received the tokens using [cleos get currency balance](https://docs.eosnetwork.com/manuals/eos/v2.2/cleos/command-reference/get/currency-balance)
