...
For more information about deploying smart contracts to your accounts, please see our [DUNE Guide](/docs/20_smart-contracts/10_getting-started/10_dune-guide/index.md). 
...
Go to our [Resources Guide](/docs/20_smart-contracts/10_getting-started/30_resources/index.md) to learn how to calculate the cost of purchasing RAM from the RAM Market.
