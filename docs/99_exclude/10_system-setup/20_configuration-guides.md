...
* [Configure Nodeos as a Local Single-node Testnet](https://docs.eosnetwork.com/manuals/eos/v2.2/nodeos/usage/development-environment/local-single-node-testnet) 
...
* [Configure Nodeos as a Local Two-Node Testnet](https://docs.eosnetwork.com/manuals/eos/v2.2/nodeos/usage/development-environment/local-multi-node-testnet)
...
* [Antelope Testnet Quick Start Guide.](https://docs.eosnetwork.com/welcome/v2.2/quick-start-guides/testnet-quick-start-guide/index) 
 ...
 * [Producing Node](https://docs.eosnetwork.com/manuals/eos/v2.2/nodeos/usage/node-setups/producing-node)
 * [Non-Producing Node](https://docs.eosnetwork.com/manuals/eos/v2.2/nodeos/usage/node-setups/non-producing-node)
