...
* The Antelope platform software, Click on this link for instructions on [installing Antelope binaries.](../30_getting-started-guide/20_local-development-environment/10_installing-eosio-binaries.md "Getting started - install binaries") 
