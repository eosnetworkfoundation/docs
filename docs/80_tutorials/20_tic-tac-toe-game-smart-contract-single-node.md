...
Run [nodeos](https://docs.eosnetwork.com/manuals/eos/v2.0/nodeos/index) locally to start a blockchain running on a single node. [Configure nodeos](https://docs.eosnetwork.com/manuals/eos/v2.0/nodeos/usage/nodeos-configuration) with [plugins](https://docs.eosnetwork.com/manuals/eos/v2.0/nodeos/plugins/index) to produce blocks, store a history of the blockchain in memory, provide HTTP RPC access to these plugins and to output running information to a file.
...
1. Create a wallet - [How To Create A Wallet](https://docs.eosnetwork.com/manuals/eos/v2.0/cleos/how-to-guides/how-to-create-a-wallet)
2. Create key pair - [How To Create Key Pairs](https://docs.eosnetwork.com/manuals/eos/v2.0/cleos/how-to-guides/how-to-create-key-pairs)
3. Create the account - [How To Create An Account](https://docs.eosnetwork.com/manuals/eos/v2.0/cleos/how-to-guides/how-to-create-an-account#gatsby-focus-wrapper)
4. Import the account private key to the wallet - [How To Import A Key](https://docs.eosnetwork.com/manuals/eos/v2.0/cleos/how-to-guides/how-to-import-a-key)
...
#### Cleos Commands
To use the command line to create the accounts run the following commands. Make sure that the local wallet is [open](https://docs.eosnetwork.com/manuals/eos/v2.0/cleos/command-reference/wallet/open) and [unlocked](https://docs.eosnetwork.com/manuals/eos/v2.0/cleos/command-reference/wallet/unlock) and run these commands to create the accounts with the private keys stored in the local wallet.
...
[Deploy the smart contract](https://docs.eosnetwork.com/manuals/eos/v2.0/cleos/how-to-guides/how-to-deploy-a-smart-contract) on the single node testnet tictactoe account with the following command.
...
## Play The Game
Now that the smart contract has been successfully deployed [push smart contract actions](https://docs.eosnetwork.com/manuals/eos/v2.0/cleos/command-reference/push/push-action) to the blockchain to play the game.  
