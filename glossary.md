...
## RFP
Request for Proposal. An RFP is a public request from the EOSIO+ coalition for bids on a body of work.
...
An encoding for a private EDSA key. EOSIO uses the same version, checksum, and encoding scheme as the Bitcoin WIF addresses and should be compatible with existing libraries. 
**Abbreviation**: WIF
